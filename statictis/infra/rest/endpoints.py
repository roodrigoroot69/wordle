...
from statictis.infra.repositories.statictis_repository import PostgresStatictisRepository
...
def get_accurate_Words(db: Session = Depends(get_db),):
    postgres_statictis_repository = PostgresStatictisRepository(
        db=db
    )
